...
function agregarAlcarrito(nombre, precio){
    ...
    actulizarCarrito(); // actualiza el contado lo llamo porque debe cambiar en contador con o que estoy ingresando
    actulizarPrecioTotal();
...
// funcion actializar precio total
 function actulizarPrecioTotal(){
    ...
    contadorPrecioTotal.textContent = "$" + precioTotal.toLocaleString('es-CO'); // Muestra un número como dinero colombiano en pantalla
